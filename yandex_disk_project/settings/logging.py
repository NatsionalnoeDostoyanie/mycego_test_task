...
class DebugAndInfoOnlyFilter(logging.Filter):
    ...
    This filter can be added to a logger or a handler to ensure that only messages with a severity level of DEBUG or
    INFO are processed. Messages with other levels, such as WARNING, ERROR, or CRITICAL, will be ignored.
    """
